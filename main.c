...
//
            ...
            cercleVide(pRenderer, 200, 500, 100, 1000);

            cerclePlein(pRenderer, 500, 500, 100, 1000);
    /*
            //----------------------------------------------------------------------------//
    ...
    */
            ...
            SDL_Rect rectT = {500, 0, 100, 100}; //création d'un carré acceuillant la texture
            SDL_SetRenderDrawColor(pRenderer, 150, 0, 150, 255); //mise en place du dessein dans la texture
